    ...
    return (
        <div>
            ...
            <div className="card-body " style={{ maxHeight: "100%" }}>
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-3">
                        <div className="d-flex justify-content-start ">
                            ...
                            <div className="d-flex align-items-start flex-wrap">
                                <h4 className="text-white mt-2 text-white"><b>Overview Project</b></h4>

                            </div>
                        </div>
                        <div className="d-flex align-items-center">

                            <button className="btn text-utama rounded-pill">See More...</button>
                        </div>
                    </div>
                ...
                <p className="text-second ps-3">Hello, I'm Wahyu Nusantara. I'm a fresh graduate from AMIKOM University Yogyakarta. With a background
